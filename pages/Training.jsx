                ...
                cards.map((item, i) =>{
                    ...
                    <div style={{display:'flex', justifyContent:'space-around', flexWrap:'wrap', padding:'50px 5px'}}>
                        <div style={{textAlign:'center'}}>
                            ...
                            <a className="btn btn-light font-weight-bold" style={{ color:'#000', minWidth:120}} href="mailto:sebastian@sebrussi.com?subject=One-to-One Coaching">sebastian@sebrussi.com</a>
                        </div>
                    </div>
